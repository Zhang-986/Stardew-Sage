package com.aurora.common.utils.file;
...
import com.aurora.common.exception.file.FileNameLengthLimitExceededException;
import com.aurora.common.exception.file.FileSizeLimitExceededException;
import com.aurora.common.exception.file.InvalidExtensionException;
import com.aurora.common.utils.DateUtils;
import com.aurora.common.utils.StringUtils;
import com.aurora.common.utils.uuid.IdUtils;
import com.aurora.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = AuroraConfig.getProfile();
    ...
    {
        int dirLastIndex = AuroraConfig.getProfile().length() + 1;
