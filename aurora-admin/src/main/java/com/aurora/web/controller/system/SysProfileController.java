...
import com.aurora.common.utils.file.FileUploadUtils;
import com.aurora.common.utils.file.FileUtils;
import com.aurora.common.utils.file.MimeTypeUtils;
import com.aurora.framework.web.service.TokenService;
...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception
    {
        ...
        {
            LoginUser loginUser = getLoginUser();
            String avatar = FileUploadUtils.upload(AuroraConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION, true);
            if (userService.updateUserAvatar(loginUser.getUserId(), avatar))
            {
                String oldAvatar = loginUser.getUser().getAvatar();
                if (StringUtils.isNotEmpty(oldAvatar))
                {
                    FileUtils.deleteFile(AuroraConfig.getProfile() + FileUtils.stripPrefix(oldAvatar));
                }
