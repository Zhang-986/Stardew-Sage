...
The upload files and `SHA256SUMS.txt` are written to `dist/nexus/0.2.0/`. Upload `windows-x64` as the main file and the other three archives as optional platform files. Keep their names unchanged.
