...
- [x] **Step 2: Write failing confidence and cooling tests**
...
- [x] **Step 4: Implement minimal domain policy**
...
- [x] **Step 3: Implement schema and atomic append**
...
- [x] **Step 2: Write failing matcher tests**
...
- [x] **Step 4: Implement projection and cooling**
...
- [x] **Step 1: Write failing strict JSON and presenter tests**
...
- [x] **Step 3: Implement contracts, schema, and presentation**
...
- [x] **Step 1: Extend the cross-process demo**
...
- [x] **Step 2: Document the feedback boundary**
...
- [x] **Step 4: Rebuild deterministic sidecars and smoke native health**
