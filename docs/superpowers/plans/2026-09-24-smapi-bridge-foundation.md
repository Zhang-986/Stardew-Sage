...
- [ ] **Step 1: Install the .NET 8 SDK locally**
...
- [ ] **Step 2: Create the solution and test project**
...
- [ ] **Step 1: Write failing golden JSON tests**
...
- [ ] **Step 3: Implement contracts and strict JSON options**
...
- [ ] **Step 3: Implement transport and correlation checks**
...
- [ ] **Step 3: Verify red, then implement minimal runtime**
...
- [ ] **Step 1: Create the SMAPI project metadata**
...
- [ ] **Step 3: Document the unavailable local integration gate**
...
- [ ] **Step 1: Write a cross-process integration test**
...
- [ ] **Step 3: Document install and live-game smoke steps**
