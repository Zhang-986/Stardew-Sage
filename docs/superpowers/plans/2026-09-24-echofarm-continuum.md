...
- [x] **Step 4: Update the JSON schemas and run tests**
...
- [x] **Step 1: Write failing merger tests**
...
- [x] **Step 3: Implement merge and projection**
...
- [x] **Step 4: Run focused and domain tests**
...
- [x] **Step 4: Run intelligence tests**
...
- [x] **Step 3: Add the revision table and store methods**
...
- [x] **Step 4: Integrate `modeling.Merge` into `learning.Service`**
...
- [x] **Step 3: Implement intent graph and coordination context**
...
- [x] **Step 4: Enforce claims after AI selection**
...
- [x] **Step 3: Add SQLite tables and repository methods**
...
- [x] **Step 4: Integrate coordinator and ledger into policy**
...
- [x] **Step 5: Implement the memory view projection**
...
- [x] **Step 3: Wire services and strict JSON handlers**
...
- [x] **Step 1: Add fixtures and a failing assertion script**
...
- [x] **Step 3: Implement bridge contracts, window and presenter**
...
- [x] **Step 4: Connect session snapshots and HTTP client**
...
- [x] **Step 1: Add `MemoryKey` and semantic activity forwarding**
...
- [x] **Step 2: Implement the read-only overlay**
...
- [x] **Step 3: Perform source-level SMAPI API audit**
...
- [x] **Step 2: Update product and release documentation**
